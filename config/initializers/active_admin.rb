ActiveAdmin.unregister ActiveAdmin::Comment rescue nil
...
ActiveAdmin.setup do |config|
  ...
  config.namespace :admin do |admin|
    admin.build_menu do |menu|
      ...
      menu.add label: "Artigos", url: "/admin/solar_contents", priority: 2
      menu.add label: "Avaliações", url: "/admin/solar_reviews", priority: 3
      menu.add label: "H2 ADS", url: "#", priority: 4
      ...
      menu.add label: "Categoria", url: "/admin/categories", priority: 7
      menu.add label: "Conteúdos", url: "/admin/solar_contents", priority: 8
      menu.add label: "FÓRUM - Perguntas", url: "#", priority: 9
      menu.add label: "FÓRUM - Respostas", url: "#", priority: 10
      menu.add label: "Feature Groups", url: "#", priority: 11
      menu.add label: "Planos e preços", url: "/admin/plans", priority: 12
      menu.add label: "Produtos", url: "/admin/solar_companies", priority: 13
      menu.add label: "Proveedores", url: "/admin/solar_companies", priority: 14
      menu.add label: "SAAS - Gestão de acesso a produto", url: "#", priority: 15
      menu.add label: "SAAS - Gestão de membros", url: "/admin/solar_users", priority: 16
      menu.add label: "SAAS - Gestão de planos", url: "/admin/plans", priority: 17
      menu.add label: "SAAS - Patrocinados", url: "#", priority: 18
    end
  end
