class Post < ApplicationRecord
  ...
  has_many :notifications, through: :solar_user, dependent: :destroy
  has_many :notification_mentions, through: :solar_user, dependent: :destroy
  ...
  def self.ransackable_attributes(_auth_object = nil)
    %w[title body comments solar_user] # Allow searching by title, body, comments  and user
  end
